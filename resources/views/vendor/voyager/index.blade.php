                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ \App\Models\Job::all()->count() }}</div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                <strong>Total Company</strong></div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ \App\Company::all()->count() }}</div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                <strong>Countries</strong></div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ \App\Models\Country::all()->count() }}</div>
                                        </div>
                                        <div class="col-auto">
